package org.jluc.tools.resources.kvfile;
...
import org.jluc.tools.resources.kvfile.impl.GenericKeyValueFile;
...
public class DicoBuilder implements Runnable {
    ...
    public DicoBuilder(File baseDirectory) {
        this(baseDirectory, new ArrayList<GenericKeyValueFile>(), true);
    }
    ...
    public DicoBuilder(final File baseDirectory, List<GenericKeyValueFile> bundlesToLoad,
            boolean generateFrameworkBundles) {
        mBaseDirectory = baseDirectory;

        List<GenericKeyValueFile> frameworkBundles = new ArrayList<GenericKeyValueFile>();
        if (generateFrameworkBundles) {
            frameworkBundles.add(DicoDecoComputerConfig.INSTANCE);
        }
    ...
    public static void main(String[] args) {
        ...
        if (args.length >= 2) {
            ...
            builder = new DicoBuilder(basedir, listOfBundles, false);
        } else {
