package org.jluc.tools.logging;
...
public final class LogTracer {
    /** Group. */
    protected static final String LOG_GROUP = "decocomputer";

    /** Default logger. */
    protected static final Logger LOGGER = Logger.getLogger(LOG_GROUP);

    static {
        initLogConfiguration(Tools.getText(DicoDecoComputerConfig.INSTANCE, DicoDecoComputerConfig.LOG4J_FILE));
    }
